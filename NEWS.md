...
- All PMTiles files are now hosted in a [R2 bucket](https://developers.cloudflare.com/r2/buckets/) on [Cloudflare](https://www.cloudflare.com/) under a custom domain: <https://tiles.pmtiles.com.br>
