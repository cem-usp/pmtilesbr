...
One way to check for a PMTiles file metadata is to use the [`pm_show()`](https://walkerke.r-universe.dev/pmtiles/doc/manual.html#pm_show) function from the [`pmtiles`](https://walkerke.github.io/pmtiles/) R package [@walker2025]. This function retrieves the metadata of a PMTiles file, including the bounds, zoom levels, and the fields available. Here is an example:
